// Header — Ultra Premium v2 + Rise of a Legend extensions
function GlobalHeader({ shared, mode, setMode, totalPct, onOpenSettings, onOpenClasses }) {
  const level = window.DA.getLevelInfo(shared.xp);
  const dragonClass = shared.dragonClass || 'mago';
  return (
    <header className="header-sticky">
      <div style={{
        ...
        {/* Class badge — NEW */}
        {window.ClassBadge && (
          <ClassBadge classId={dragonClass} size="md" onClick={onOpenClasses} />
        )}
